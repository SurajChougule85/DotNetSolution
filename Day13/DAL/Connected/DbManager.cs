...
//Establish a server...
    public static string conString=@"server=localhost;port=3306;user=root;passward=suraj@123;database=store";
    ...
    try{
        ...
        MySolCommand command=new MySolCommand();
        command.cmd=connection;
     ...
     public static Department GetDeparmentDetails(int id){
        ...
        try
        {
            ...
            //passing query and connection through parameter...
