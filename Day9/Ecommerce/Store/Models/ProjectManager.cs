...
public class ProductManager{
   ...
   public static List<Product> SoldOutProduct(){

    List<Product> prd=GetAllProducts();

    var SoldOutProduct=from prod in prd
      ...
      public static List<Product> GetAllProducts()
        {
            ...
            allProducts.Add(new Product { ProductId = 1, Title = "Gerbera", Description = "Wedding Flower", UnitPrice = 6, Category = "Fruits", Balance = 5000 });
            allProducts.Add(new Product { ProductId = 2, Title = "Rose", Description = "Valentine Flower", UnitPrice = 15, Category = "Fruits", Balance = 7000 });
